...
import com.swd392.ticket_resell_be.configs.VNPayConfig;
...
public class VNPayServiceImplement {
    ...
    public VNPayOrderResponse createOrder(long total, String orderInfor, HttpServletRequest request) {
        ...
        String urlReturn = VNPayConfig.getReturnUrl(request);
        vnp_Params.put("vnp_ReturnUrl", urlReturn);
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);


        TimeZone singaporeTimeZone = TimeZone.getTimeZone("Asia/Singapore");
        Calendar cld = Calendar.getInstance(singaporeTimeZone);
        SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
        formatter.setTimeZone(singaporeTimeZone);
        ...
        return new VNPayOrderResponse(paymentUrl, vnp_TxnRef);
    }
